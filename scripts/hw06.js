...
//комментарий комментарий, помоги мне запушить эту хрень


// Задание 14. Создайте массив, состоящий из 10 значений

// Генерируем исходный массив из 10 случайных чисел в диапазоне от 0 до 10
const originalArray = [];
for (let i = 0; i < 10; i++) {
...
// Создаем массив с четными значениями из исходного массива
const evenArray = originalArray.filter(num => num % 2 === 0);
console.log('Массив с четными значениями:', evenArray);


// Задание 15. Создайте массив, состоящий из 6 элементов. Требуется найти среднее арифметическое этих цифр, результат программы вывести в консоль.


// Генерируем массив из 6 случайных чисел в диапазоне от 1 до 10
